 ...
 * @author DELL
 */
@WebServlet(name = "ReferenceController", urlPatterns = {"/ReferenceController"})
public class ReferenceController extends HttpServlet {
private ReferenceService rs = new ReferenceService();
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       if(op.equals("Envoyer")){
           ...
           rs.create(new Reference( libelle) );
           response.sendRedirect("referenceForm.jsp");
